...
For questions regarding the dataset or its processing, please reach out via email:

[christoph.riepe@charite.de](mailto:christoph.riepe@charite.de)

## Dataset Components

Detailed documentation for each component is available in the corresponding subdirectory.

## Inclusion Criteria

Cases were selected based on three criteria: observation period, organ system, and patient age. Each criterion is described in detail below.

### Observation Period

Cases were included if the incision time of the index operation fell within the period from 2014 to 2022.

### Organ Systems

Cases were included if the index surgery was performed on one of the following five organ systems.
...
Cases were included if the index surgery was classified under one of the following OPS procedure codes.
...
Only cases in which the patient was at least 18 years of age at the time of the index operation were included.
